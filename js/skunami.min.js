var SKUNAMI=SKUNAMI||{version:"1.0.1"};console.log("Using SKUNAMI "+SKUNAMI.version);
...
0,0);this.__rttDisplay=this.__rttRenderTarget1.clone();this.__clearRenderTarget(this.__rttDisplay,0,0,0,0);this.__rttFloatEncoderRenderTarget=new THREE.WebGLRenderTarget(this.__res,this.__res,this.__nearestFloatRgbaParams);this.__rttFloatEncoderRenderTarget.generateMipmaps=!1;this.__clearRenderTarget(this.__rttFloatEncoderRenderTarget,0,0,0,0);this.__rttCombinedHeightsBlurredRenderTarget=this.__rttRenderTarget1.clone();this.__clearRenderTarget(this.__rttCombinedHeightsBlurredRenderTarget,0,0,0,0);
this.__rttDynObstaclesBlurredRenderTarget=this.__rttRenderTarget1.clone();this.__clearRenderTarget(this.__rttDynObstaclesBlurredRenderTarget,0,0,0,0);this.__rttDisturbMapRenderTarget=this.__rttRenderTarget1.clone();this.__clearRenderTarget(this.__rttDisturbMapRenderTarget,0,0,0,0)};
...
c.__skhfwater.isDynamic){c.visible=!0;b.__clearRenderTarget(b.__rttObstacleTopRenderTarget,0,0,0,0);b.__clearRenderTarget(b.__rttObstacleBottomRenderTarget,0,0,0,0);b.__renderer.render(b.__scene,b.__rttObstaclesTopCamera,b.__rttObstacleTopRenderTarget,!1);b.__renderer.render(b.__scene,b.__rttObstaclesBottomCamera,b.__rttObstacleBottomRenderTarget,!1);b.__rttQuadMesh.material=b.__dynObstaclesMaterial;b.__dynObstaclesMaterial.uniforms.uObstaclesTexture.value=b.__rttDynObstaclesRenderTarget;b.__dynObstaclesMaterial.uniforms.uObstacleTopTexture.value=
b.__rttObstacleTopRenderTarget;b.__dynObstaclesMaterial.uniforms.uObstacleBottomTexture.value=b.__rttObstacleBottomRenderTarget;b.__dynObstaclesMaterial.uniforms.uWaterTexture.value=b.__rttCombinedHeightsBlurredRenderTarget;b.__dynObstaclesMaterial.uniforms.uTerrainTexture.value=b.__emptyTexture;b.__renderer.render(b.__rttScene,b.__rttCamera,b.__rttDynObstaclesRenderTarget,!1);b.__pr.reduce(b.__rttDynObstaclesRenderTarget,"sum","a");c.__skhfwater.totalDisplacedVol=b.__pr.getPixelFloatData("a")[0]*
b.__segmentSizeSquared;b.__rttQuadMesh.material=b.__maskWaterMaterial;b.__maskWaterMaterial.uniforms.uTexture1.value=b.__rttRenderTarget1;b.__maskWaterMaterial.uniforms.uTexture2.value=b.__rttObstacleTopRenderTarget;b.__renderer.render(b.__rttScene,b.__rttCamera,b.__rttMaskedWaterRenderTarget,!1);b.__pr.reduce(b.__rttMaskedWaterRenderTarget,"sum","g");c.__skhfwater.totalVelocityX=b.__pr.getPixelFloatData("g")[0];b.__pr.reduce(b.__rttMaskedWaterRenderTarget,"sum","b");c.__skhfwater.totalVelocityZ=
b.__pr.getPixelFloatData("b")[0];b.__pr.reduce(b.__rttObstacleTopRenderTarget,"sum","a");c.__skhfwater.totalArea=b.__pr.getPixelFloatData("a")[0];0===c.__skhfwater.totalArea?(c.__skhfwater.averageVelocityX=0,c.__skhfwater.averageVelocityZ=0):(c.__skhfwater.averageVelocityX=c.__skhfwater.totalVelocityX/c.__skhfwater.totalArea,c.__skhfwater.averageVelocityZ=c.__skhfwater.totalVelocityZ/c.__skhfwater.totalArea);c.__skhfwater.forceX=c.__skhfwater.averageVelocityX/a*c.__skhfwater.mass;c.__skhfwater.forceY=
c.__skhfwater.totalDisplacedVol*b.__density*b.__gravity;c.__skhfwater.forceZ=c.__skhfwater.averageVelocityZ/a*c.__skhfwater.mass;if(b.__callbacks.hasOwnProperty("exertForce")){var e=b.__callbacks.exertForce,d,f;d=0;for(f=e.length;d<f;d++)e[d](c,new THREE.Vector3(c.__skhfwater.forceX,c.__skhfwater.forceY,c.__skhfwater.forceZ))}c.visible=!1}});this.__scene.overrideMaterial=null;this.__scene.traverse(function(a){a.visible=a.visibleStore});this.__rttQuadMesh.material=this.__gaussianBlurXMaterial;this.__gaussianBlurXMaterial.uniforms.uTexture.value=
this.__rttDynObstaclesRenderTarget;this.__gaussianBlurXMaterial.uniforms.uTexelSize.value=1/this.__res;this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttDynObstaclesBlurredRenderTarget,!1);this.__rttQuadMesh.material=this.__gaussianBlurYMaterial;this.__gaussianBlurYMaterial.uniforms.uTexture.value=this.__rttDynObstaclesBlurredRenderTarget;this.__gaussianBlurYMaterial.uniforms.uTexelSize.value=1/this.__res;this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttDynObstaclesBlurredRenderTarget,
!1);this.__rttQuadMesh.material=this.__calcDisturbMapMaterial;this.__calcDisturbMapMaterial.uniforms.uTexture.value=this.__rttDynObstaclesBlurredRenderTarget;this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttDisturbMapRenderTarget,!1);this.__disturbMapHasUpdated=!0};
