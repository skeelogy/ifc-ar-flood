var SKUNAMI=SKUNAMI||{version:"1.0.0"};console.log("Using SKUNAMI "+SKUNAMI.version);
...
this.__dampingFactor=a.dampingFactor;this.__multisteps=a.multisteps||1;this.__shouldDisplaySimTexture=!1;this.__gravity=9.81;this.__density=a.density||1E3;this.__halfSize=this.__size/2;this.__segmentSize=this.__size/this.__res;this.__segmentSizeSquared=this.__segmentSize*this.__segmentSize;this.__texelSize=1/this.__res;this.__isDisturbing=this.__disturbMapHasUpdated=!1;this.__disturbUvPos=new THREE.Vector2;this.__disturbAmount=0;this.__disturbRadius=0.0025*this.__size;this.__linearFloatRgbaParams=
{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,wrapS:THREE.ClampToEdgeWrapping,wrapT:THREE.ClampToEdgeWrapping,format:THREE.RGBAFormat,stencilBuffer:!1,depthBuffer:!1,type:THREE.FloatType};this.__nearestFloatRgbaParams={minFilter:THREE.NearestFilter,magFilter:THREE.NearestFilter,wrapS:THREE.ClampToEdgeWrapping,wrapT:THREE.ClampToEdgeWrapping,format:THREE.RGBAFormat,stencilBuffer:!1,depthBuffer:!1,type:THREE.FloatType};this.__boundaryData=new Float32Array(4*this.__res*this.__res);this.__boundaryTexture=
new THREE.DataTexture(null,this.__res,this.__res,THREE.RGBAFormat,THREE.FloatType);this.__emptyTexture=new THREE.WebGLRenderTarget(this.__res,this.__res,this.__linearFloatRgbaParams);this.__emptyTexture.generateMipmaps=!1;this.__rttObstaclesCameraRange=50;this.__pixelByteData=new Uint8Array(4*this.__res*this.__res);this.__staticObstacles=[];this.__dynObstacles=[];this.__shouldUpdateStaticObstacle=!1;this.__callbacks={};this.__initCounter=5;this.__init();this.__setupObstaclesScene()};
SKUNAMI.GpuHeightFieldWater.prototype.getShouldDisplaySimTexture=function(){return this.__shouldDisplaySimTexture};SKUNAMI.GpuHeightFieldWater.prototype.setShouldDisplaySimTexture=function(a){this.__shouldDisplaySimTexture=a};SKUNAMI.GpuHeightFieldWater.prototype.__init=function(){this.__checkExtensions();this.__setupShaders();this.__setupRttScene();this.__setupVtf();this.__initDataAndTextures();this.__pr=new SKPR.ParallelReducer(this.__renderer,this.__res,1)};
SKUNAMI.GpuHeightFieldWater.prototype.__getWaterFragmentShaderContent=function(){throw Error("Abstract method not implemented");};
...
this.__gaussianBlurXMaterial=new THREE.ShaderMaterial({uniforms:{uTexture:{type:"t",value:this.__emptyTexture},uTexelSize:{type:"f",value:this.__texelSize}},vertexShader:this.__shaders.vert.passUv,fragmentShader:this.__shaders.frag.gaussianBlurX});this.__gaussianBlurYMaterial=new THREE.ShaderMaterial({uniforms:{uTexture:{type:"t",value:this.__emptyTexture},uTexelSize:{type:"f",value:this.__texelSize}},vertexShader:this.__shaders.vert.passUv,fragmentShader:this.__shaders.frag.gaussianBlurY});this.__combineTexturesMaterial=
new THREE.ShaderMaterial({uniforms:{uTexture1:{type:"t",value:this.__emptyTexture},uTexture2:{type:"t",value:this.__emptyTexture}},vertexShader:this.__shaders.vert.passUv,fragmentShader:this.__shaders.frag.combineTextures});this.__erodeMaterial=new THREE.ShaderMaterial({uniforms:{uTexture:{type:"t",value:this.__emptyTexture},uTexelSize:{type:"f",value:this.__texelSize}},vertexShader:this.__shaders.vert.passUv,fragmentShader:this.__shaders.frag.erode});this.__channelVectors={r:new THREE.Vector4(1,
0,0,0),g:new THREE.Vector4(0,1,0,0),b:new THREE.Vector4(0,0,1,0),a:new THREE.Vector4(0,0,0,1)}};
SKUNAMI.GpuHeightFieldWater.prototype.__setupRttScene=function(){this.__rttScene=new THREE.Scene;this.__rttCamera=new THREE.OrthographicCamera(-this.__halfSize,this.__halfSize,this.__halfSize,-this.__halfSize,-1E4,1E4);this.__rttQuadGeom=new THREE.PlaneGeometry(this.__size,this.__size);this.__rttQuadMesh=new THREE.Mesh(this.__rttQuadGeom,this.__waterSimMaterial);this.__rttScene.add(this.__rttQuadMesh);this.__rttRenderTarget1=new THREE.WebGLRenderTarget(this.__res,this.__res,this.__linearFloatRgbaParams);
this.__rttRenderTarget1.generateMipmaps=!1;this.__rttRenderTarget2=this.__rttRenderTarget1.clone();this.__rttDisplay=this.__rttRenderTarget1.clone();this.__rttFloatEncoderRenderTarget=new THREE.WebGLRenderTarget(this.__res,this.__res,this.__nearestFloatRgbaParams);this.__rttFloatEncoderRenderTarget.generateMipmaps=!1;this.__rttCombinedHeightsBlurredRenderTarget=this.__rttRenderTarget1.clone();this.__rttDynObstaclesBlurredRenderTarget=this.__rttRenderTarget1.clone();this.__rttDisturbMapRenderTarget=
...
0.95,1)}}]),vertexShader:this.__shaders.vert.heightMap,fragmentShader:this.__shaders.frag.lambert,lights:!0})};SKUNAMI.GpuHeightFieldWater.prototype.__checkExtensions=function(a){a=this.__renderer.context;if(!a.getExtension("OES_texture_float_linear"))throw Error("Extension not available: OES_texture_float_linear");if(!a.getParameter(a.MAX_VERTEX_TEXTURE_IMAGE_UNITS))throw Error("Vertex textures not supported on your graphics card");};
...
SKUNAMI.GpuHeightFieldWater.prototype.reset=function(){this.__initCounter=5};SKUNAMI.GpuHeightFieldWater.prototype.__resetPass=function(){this.__rttQuadMesh.material=this.__resetMaterial;this.__resetMaterial.uniforms.uColor.value.set(this.__meanHeight,0,0,this.__meanHeight);this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttRenderTarget2,!1);this.__swapRenderTargets()};
SKUNAMI.GpuHeightFieldWater.prototype.disturb=function(a,b,c){this.__isDisturbing=!0;this.__disturbUvPos.x=(a.x+this.__halfSize)/this.__size;this.__disturbUvPos.y=(a.z+this.__halfSize)/this.__size;this.__disturbAmount=b;this.__disturbRadius=c};SKUNAMI.GpuHeightFieldWater.prototype.flood=function(a){throw Error("Abstract method not implemented");};
SKUNAMI.GpuHeightFieldWater.prototype.__disturbPass=function(){this.__isDisturbing&&(this.__rttQuadMesh.material=this.__disturbAndSourceMaterial,this.__disturbAndSourceMaterial.uniforms.uTexture.value=this.__rttRenderTarget2,this.__disturbAndSourceMaterial.uniforms.uStaticObstaclesTexture.value=this.__rttStaticObstaclesRenderTarget,this.__disturbAndSourceMaterial.uniforms.uDisturbTexture.value=this.__rttDisturbMapRenderTarget,this.__disturbAndSourceMaterial.uniforms.uIsDisturbing.value=this.__isDisturbing,
this.__disturbAndSourceMaterial.uniforms.uDisturbPos.value.copy(this.__disturbUvPos),this.__disturbAndSourceMaterial.uniforms.uDisturbAmount.value=this.__disturbAmount,this.__disturbAndSourceMaterial.uniforms.uDisturbRadius.value=this.__disturbRadius/this.__size,this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttRenderTarget1,!1),this.__swapRenderTargets(),this.__isDisturbing=!1,this.__rttQuadMesh.material.uniforms.uIsDisturbing.value=!1)};
...
SKUNAMI.GpuHeightFieldWater.prototype.__displayPass=function(){this.__shouldDisplaySimTexture&&(this.__rttQuadMesh.material=this.__setSolidAlphaMaterial,this.__setSolidAlphaMaterial.uniforms.uTexture.value=this.__rttRenderTarget2,this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttDisplay,!1),this.__swapRenderTargets())};SKUNAMI.GpuHeightFieldWater.prototype.__calculateSubsteps=function(a){return 1};
...
SKUNAMI.GpuHeightFieldWater.prototype.addStaticObstacle=function(a){if(!(a instanceof THREE.Mesh))throw Error("mesh must be of type THREE.Mesh");a.__skhfwater||(a.__skhfwater={});a.__skhfwater.isObstacle=!0;a.__skhfwater.isDynamic=!1;a.__skhfwater.mass=0;this.__staticObstacles.push(a);this.__shouldUpdateStaticObstacle=!0};
SKUNAMI.GpuHeightFieldWater.prototype.addDynamicObstacle=function(a,b){if(!(a instanceof THREE.Mesh))throw Error("mesh must be of type THREE.Mesh");if("undefined"===typeof b)throw Error("mass not specified");a.__skhfwater||(a.__skhfwater={});a.__skhfwater.isObstacle=!0;a.__skhfwater.isDynamic=!0;a.__skhfwater.mass=b;this.__dynObstacles.push(a)};
...
SKUNAMI.GpuHeightFieldWater.prototype.__updateStaticObstacleTexture=function(a){this.__rttQuadMesh.material=this.__resetMaterial;this.__resetMaterial.uniforms.uColor.value.set(0,0,0,1);this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttStaticObstaclesRenderTarget,!1);this.__resetMaterial.uniforms.uColor.value.set(0,0,0,0);this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttObstacleTopRenderTarget,!1);this.__scene.traverse(function(a){a.visibleStore=a.visible;a.visible=
!1});this.__scene.overrideMaterial=this.__rttObstaclesDepthMaterial;var b;a=0;for(b=this.__staticObstacles.length;a<b;a++)this.__staticObstacles[a].visible=!0;this.__renderer.render(this.__scene,this.__rttObstaclesTopCamera,this.__rttObstacleTopRenderTarget,!1);this.__rttQuadMesh.material=this.__staticObstaclesMaterial;this.__staticObstaclesMaterial.uniforms.uObstacleTopTexture.value=this.__rttObstacleTopRenderTarget;this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttStaticObstaclesRenderTarget,
!1);this.__rttQuadMesh.material=this.__erodeMaterial;this.__erodeMaterial.uniforms.uTexture.value=this.__rttStaticObstaclesRenderTarget;this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttStaticObstaclesRenderTarget,!1);this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttStaticObstaclesRenderTarget,!1);this.__scene.overrideMaterial=null;this.__scene.traverse(function(a){a.visible=a.visibleStore})};
...
this.__gaussianBlurYMaterial.uniforms.uTexture.value=this.__rttCombinedHeightsBlurredRenderTarget;this.__gaussianBlurYMaterial.uniforms.uTexelSize.value=1/this.__res;this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttCombinedHeightsBlurredRenderTarget,!1);var b=this;this.__scene.traverse(function(a){a.visibleStore=a.visible;a.visible=!1});this.__scene.overrideMaterial=this.__rttObstaclesDepthMaterial;this.__scene.traverse(function(c){if(c instanceof THREE.Mesh&&c.__skhfwater&&c.__skhfwater.isObstacle&&
c.__skhfwater.isDynamic){c.visible=!0;b.__rttQuadMesh.material=b.__resetMaterial;b.__resetMaterial.uniforms.uColor.value.set(0,0,0,0);b.__renderer.render(b.__rttScene,b.__rttCamera,b.__rttObstacleTopRenderTarget,!1);b.__renderer.render(b.__rttScene,b.__rttCamera,b.__rttObstacleBottomRenderTarget,!1);b.__renderer.render(b.__scene,b.__rttObstaclesTopCamera,b.__rttObstacleTopRenderTarget,!1);b.__renderer.render(b.__scene,b.__rttObstaclesBottomCamera,b.__rttObstacleBottomRenderTarget,!1);b.__rttQuadMesh.material=
b.__dynObstaclesMaterial;b.__dynObstaclesMaterial.uniforms.uObstaclesTexture.value=b.__rttDynObstaclesRenderTarget;b.__dynObstaclesMaterial.uniforms.uObstacleTopTexture.value=b.__rttObstacleTopRenderTarget;b.__dynObstaclesMaterial.uniforms.uObstacleBottomTexture.value=b.__rttObstacleBottomRenderTarget;b.__dynObstaclesMaterial.uniforms.uWaterTexture.value=b.__rttCombinedHeightsBlurredRenderTarget;b.__dynObstaclesMaterial.uniforms.uTerrainTexture.value=b.__emptyTexture;b.__renderer.render(b.__rttScene,
b.__rttCamera,b.__rttDynObstaclesRenderTarget,!1);b.__pr.reduce(b.__rttDynObstaclesRenderTarget,"sum","a");c.__skhfwater.totalDisplacedVol=b.__pr.getPixelFloatData("a")[0]*b.__segmentSizeSquared;b.__rttQuadMesh.material=b.__maskWaterMaterial;b.__maskWaterMaterial.uniforms.uTexture1.value=b.__rttRenderTarget1;b.__maskWaterMaterial.uniforms.uTexture2.value=b.__rttObstacleTopRenderTarget;b.__renderer.render(b.__rttScene,b.__rttCamera,b.__rttMaskedWaterRenderTarget,!1);b.__pr.reduce(b.__rttMaskedWaterRenderTarget,
"sum","g");c.__skhfwater.totalVelocityX=b.__pr.getPixelFloatData("g")[0];b.__pr.reduce(b.__rttMaskedWaterRenderTarget,"sum","b");c.__skhfwater.totalVelocityZ=b.__pr.getPixelFloatData("b")[0];b.__pr.reduce(b.__rttObstacleTopRenderTarget,"sum","a");c.__skhfwater.totalArea=b.__pr.getPixelFloatData("a")[0];0===c.__skhfwater.totalArea?(c.__skhfwater.averageVelocityX=0,c.__skhfwater.averageVelocityZ=0):(c.__skhfwater.averageVelocityX=c.__skhfwater.totalVelocityX/c.__skhfwater.totalArea,c.__skhfwater.averageVelocityZ=
c.__skhfwater.totalVelocityZ/c.__skhfwater.totalArea);c.__skhfwater.forceX=c.__skhfwater.averageVelocityX/a*c.__skhfwater.mass;c.__skhfwater.forceY=c.__skhfwater.totalDisplacedVol*b.__density*b.__gravity;c.__skhfwater.forceZ=c.__skhfwater.averageVelocityZ/a*c.__skhfwater.mass;if(b.__callbacks.hasOwnProperty("exertForce")){var e=b.__callbacks.exertForce,d,f;d=0;for(f=e.length;d<f;d++)e[d](c,new THREE.Vector3(c.__skhfwater.forceX,c.__skhfwater.forceY,c.__skhfwater.forceZ))}c.visible=!1}});this.__scene.overrideMaterial=
null;this.__scene.traverse(function(a){a.visible=a.visibleStore});this.__rttQuadMesh.material=this.__gaussianBlurXMaterial;this.__gaussianBlurXMaterial.uniforms.uTexture.value=this.__rttDynObstaclesRenderTarget;this.__gaussianBlurXMaterial.uniforms.uTexelSize.value=1/this.__res;this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttDynObstaclesBlurredRenderTarget,!1);this.__rttQuadMesh.material=this.__gaussianBlurYMaterial;this.__gaussianBlurYMaterial.uniforms.uTexture.value=this.__rttDynObstaclesBlurredRenderTarget;
this.__gaussianBlurYMaterial.uniforms.uTexelSize.value=1/this.__res;this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttDynObstaclesBlurredRenderTarget,!1);this.__rttQuadMesh.material=this.__calcDisturbMapMaterial;this.__calcDisturbMapMaterial.uniforms.uTexture.value=this.__rttDynObstaclesBlurredRenderTarget;this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttDisturbMapRenderTarget,!1);this.__disturbMapHasUpdated=!0};
SKUNAMI.GpuHeightFieldWater.prototype.__getPixelByteDataForRenderTarget=function(a,b,c,e){var d=this.__renderer.getContext();d.bindFramebuffer(d.FRAMEBUFFER,a.__webglFramebuffer);d.readPixels(0,0,c,e,d.RGBA,d.UNSIGNED_BYTE,b);d.bindFramebuffer(d.FRAMEBUFFER,null)};
...
SKUNAMI.GpuHeightFieldWater.prototype.addCallback=function(a,b){this.__callbacks.hasOwnProperty(a)||(this.__callbacks[a]=[]);if(b)if("function"===typeof b)this.__callbacks[a].push(b);else throw Error("Specified callbackFn is not a function");else throw Error("Callback function not defined");};SKUNAMI.GpuHeightFieldWater.prototype.getWaterDisplayTexture=function(){return this.__rttDisplay};SKUNAMI.GpuHeightFieldWater.prototype.getObstaclesDisplayTexture=function(){return this.__rttDynObstaclesBlurredRenderTarget};
...
uTexelSize:{type:"v2",value:new THREE.Vector2(this.__texelSize,this.__texelSize)},uSegmentSize:{type:"f",value:this.__segmentSize},uDt:{type:"f",value:0},uMinWaterHeight:{type:"f",value:this.__minWaterHeight}},vertexShader:this.__shaders.vert.passUv,fragmentShader:this.__getWaterFragmentShaderContent()});this.__clearMaterial=new THREE.ShaderMaterial({uniforms:{uColor:{type:"v4",value:new THREE.Vector4(this.__initialWaterHeight,this.__initialWaterHeight,this.__initialWaterHeight,this.__initialWaterHeight)}},
vertexShader:this.__shaders.vert.passUv,fragmentShader:this.__shaders.frag.setColor});this.__calcFinalWaterHeightMaterial=new THREE.ShaderMaterial({uniforms:{uTerrainTexture:{type:"t",value:this.__emptyTexture},uStaticObstaclesTexture:{type:"t",value:this.__emptyTexture},uWaterTexture:{type:"t",value:this.__emptyTexture},uMultiplyTexture:{type:"t",value:this.__emptyTexture},uMaskOffset:{type:"f",value:this.__minWaterHeight}},vertexShader:this.__shaders.vert.passUv,fragmentShader:this.__shaders.frag.hfWater_pipeModel_calcFinalWaterHeight});
this.__disturbAndSourceMaterial.uniforms.uUseObstacleTexture.value=!1;this.__disturbAndSourceMaterial.uniforms.uIsFlooding={type:"i",value:0};this.__disturbAndSourceMaterial.uniforms.uFloodAmount={type:"f",value:this.__floodAmount}};
SKUNAMI.GpuPipeModelWater.prototype.__setupRttScene=function(){SKUNAMI.GpuHeightFieldWater.prototype.__setupRttScene.call(this);this.__rttRenderTargetFlux1=new THREE.WebGLRenderTarget(this.__res,this.__res,this.__linearFloatRgbaParams);this.__rttRenderTargetFlux1.generateMipmaps=!1;this.__rttRenderTargetFlux2=this.__rttRenderTargetFlux1.clone();this.__rttCombinedHeight=this.__rttRenderTarget1.clone()};
SKUNAMI.GpuPipeModelWater.prototype.source=function(a,b,c){this.__isSourcing=!0;this.__sourceUvPos.x=(a.x+this.__halfSize)/this.__size;this.__sourceUvPos.y=(a.z+this.__halfSize)/this.__size;this.__sourceAmount=b;this.__sourceRadius=c};SKUNAMI.GpuPipeModelWater.prototype.flood=function(a){this.__isFlooding=!0;this.__floodAmount=a/(this.__size*this.__size)};
SKUNAMI.GpuPipeModelWater.prototype.__disturbPass=function(){var a=!1;this.__disturbMapHasUpdated&&(this.__rttQuadMesh.material=this.__disturbAndSourceMaterial,this.__disturbAndSourceMaterial.uniforms.uTexture.value=this.__rttRenderTarget2,this.__disturbAndSourceMaterial.uniforms.uDisturbTexture.value=this.__rttDisturbMapRenderTarget,a=!0);this.__isDisturbing&&(this.__rttQuadMesh.material=this.__disturbAndSourceMaterial,this.__disturbAndSourceMaterial.uniforms.uTexture.value=this.__rttRenderTarget2,
this.__disturbAndSourceMaterial.uniforms.uIsDisturbing.value=this.__isDisturbing,this.__disturbAndSourceMaterial.uniforms.uDisturbPos.value.copy(this.__disturbUvPos),this.__disturbAndSourceMaterial.uniforms.uDisturbAmount.value=this.__disturbAmount,this.__disturbAndSourceMaterial.uniforms.uDisturbRadius.value=this.__disturbRadius/this.__size,a=!0);this.__isSourcing&&(this.__rttQuadMesh.material=this.__disturbAndSourceMaterial,this.__disturbAndSourceMaterial.uniforms.uTexture.value=this.__rttRenderTarget2,
this.__disturbAndSourceMaterial.uniforms.uIsSourcing.value=this.__isSourcing,this.__disturbAndSourceMaterial.uniforms.uSourcePos.value.copy(this.__sourceUvPos),this.__disturbAndSourceMaterial.uniforms.uSourceAmount.value=this.__sourceAmount,this.__disturbAndSourceMaterial.uniforms.uSourceRadius.value=this.__sourceRadius/this.__size,a=!0);this.__isFlooding&&(this.__rttQuadMesh.material=this.__disturbAndSourceMaterial,this.__disturbAndSourceMaterial.uniforms.uTexture.value=this.__rttRenderTarget2,this.__disturbAndSourceMaterial.uniforms.uIsFlooding.value=
this.__isFlooding,this.__disturbAndSourceMaterial.uniforms.uFloodAmount.value=this.__floodAmount,a=!0);a&&(this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttRenderTarget1,!1),this.__swapRenderTargets(),this.__disturbMapHasUpdated=!1,this.__disturbAndSourceMaterial.uniforms.uDisturbTexture.value=this.__emptyTexture,this.__isDisturbing=!1,this.__isSourcing=this.__disturbAndSourceMaterial.uniforms.uIsDisturbing.value=!1,this.__isFlooding=this.__disturbAndSourceMaterial.uniforms.uIsSourcing.value=
!1,this.__disturbAndSourceMaterial.uniforms.uIsFlooding.value=!1)};SKUNAMI.GpuPipeModelWater.prototype.__calculateSubsteps=function(a){return Math.ceil(5*a/this.__maxDt)};
SKUNAMI.GpuPipeModelWater.prototype.__resetPass=function(){this.__rttQuadMesh.material=this.__clearMaterial;this.__clearMaterial.uniforms.uColor.value.set(this.__initialWaterHeight,this.__initialWaterHeight,this.__initialWaterHeight,this.__initialWaterHeight);this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttRenderTarget2,!1);this.__clearMaterial.uniforms.uColor.value.set(0,0,0,0);this.__renderer.render(this.__rttScene,this.__rttCamera,this.__rttRenderTargetFlux2,!1)};
