var SKULPT=SKULPT||{version:"1.0.0"};console.log("Using SKULPT "+SKULPT.version);
...
this.__size/this.__res;this.__texelSize=1/this.__res;this.__imageProcessedData=new Float32Array(4*this.__res*this.__res);this.__imageDataTexture=new THREE.DataTexture(null,this.__res,this.__res,THREE.RGBAFormat,THREE.FloatType);this.__isSculpting=!1;this.__sculptUvPos=new THREE.Vector2;this.__cursorHoverColor=new THREE.Vector3(0.4,0.4,0.4);this.__cursorAddColor=new THREE.Vector3(0.3,0.5,0.1);this.__cursorRemoveColor=new THREE.Vector3(0.5,0.2,0.1);this.__shouldClear=!1;this.__linearFloatRgbParams=
{minFilter:THREE.LinearFilter,magFilter:THREE.LinearFilter,wrapS:THREE.ClampToEdgeWrapping,wrapT:THREE.ClampToEdgeWrapping,format:THREE.RGBFormat,stencilBuffer:!1,depthBuffer:!1,type:THREE.FloatType};this.__nearestFloatRgbaParams={minFilter:THREE.NearestFilter,magFilter:THREE.NearestFilter,wrapS:THREE.ClampToEdgeWrapping,wrapT:THREE.ClampToEdgeWrapping,format:THREE.RGBAFormat,stencilBuffer:!1,depthBuffer:!1,type:THREE.FloatType};this.__pixelByteData=new Uint8Array(4*this.__res*this.__res);this.__proxyPixelByteData=
new Uint8Array(4*this.__proxyRes*this.__proxyRes);this.__callbacks={};this.__init()};
...
SKULPT.GpuSkulpt.prototype.setCursorRemoveColor=function(a,b,c){this.__cursorRemoveColor.copy(a,b,c)};SKULPT.GpuSkulpt.prototype.__init=function(){this.__checkExtensions();this.__setupShaders();this.__setupRttScene();this.__setupVtf()};
SKULPT.GpuSkulpt.prototype.__checkExtensions=function(a){a=this.__renderer.context;if(!a.getExtension("OES_texture_float_linear"))throw Error("Extension not available: OES_texture_float_linear");if(!a.getParameter(a.MAX_VERTEX_TEXTURE_IMAGE_UNITS))throw Error("Vertex textures not supported on your graphics card");};
...
SKULPT.GpuSkulpt.prototype.__setupRttScene=function(){this.__rttScene=new THREE.Scene;this.__rttCamera=new THREE.OrthographicCamera(-this.__halfSize,this.__halfSize,this.__halfSize,-this.__halfSize,-1E4,1E4);this.__rttQuadGeom=new THREE.PlaneGeometry(this.__size,this.__size);this.__rttQuadMesh=new THREE.Mesh(this.__rttQuadGeom,this.__skulptMaterial);this.__rttScene.add(this.__rttQuadMesh);this.__rttRenderTarget1=new THREE.WebGLRenderTarget(this.__res,this.__res,this.__linearFloatRgbParams);this.__rttRenderTarget1.generateMipmaps=
!1;this.__rttRenderTarget2=this.__rttRenderTarget1.clone();this.__rttCombinedLayer=this.__rttRenderTarget1.clone();this.__rttProxyRenderTarget=new THREE.WebGLRenderTarget(this.__proxyRes,this.__proxyRes,this.__linearFloatRgbParams);this.__rttFloatEncoderRenderTarget=new THREE.WebGLRenderTarget(this.__res,this.__res,this.__nearestFloatRgbaParams);this.__rttFloatEncoderRenderTarget.generateMipmaps=!1};
