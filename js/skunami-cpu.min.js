...
SKUNAMICPU.VoxelizedObstacle=function(a,d,c,b,e){this.voxelizer=new SkVoxelizer(a,d,c,b,e);SKUNAMICPU.Obstacle.call(this,a)};SKUNAMICPU.VoxelizedObstacle.prototype=Object.create(SKUNAMICPU.Obstacle.prototype);SKUNAMICPU.VoxelizedObstacle.prototype.constructor=SKUNAMICPU.VoxelizedObstacle;SKUNAMICPU.VoxelizedObstacle.prototype.update=function(){this.voxelizer.updateIntersections()};
...
SKUNAMICPU.TessendorfIWaveWater=function(a){this.prevHeight=[];this.vertDeriv=[];SKUNAMICPU.HeightFieldWater.call(this,a);if("undefined"===typeof a.kernelRadius)throw Error("kernelRadius not specified");this.kernelRadius=a.kernelRadius;if("undefined"===typeof a.substeps)throw Error("substeps not specified");this.substeps=a.substeps;this.gravity=-9.81;var d="/python/iWave_kernels_"+this.kernelRadius+"_compact.json",c=this;$.ajax({url:d,async:!1}).done(function(a){c.G=a}).error(function(a,c,f){throw Error("error loading "+
d+": "+f);})};SKUNAMICPU.TessendorfIWaveWater.prototype=Object.create(SKUNAMICPU.HeightFieldWater.prototype);SKUNAMICPU.TessendorfIWaveWater.prototype.constructor=SKUNAMICPU.TessendorfIWaveWater;SKUNAMICPU.TessendorfIWaveWater.prototype.init=function(){var a;for(a=0;a<this.numVertices;a++)this.prevHeight[a]=0,this.vertDeriv[a]=0;SKUNAMICPU.HeightFieldWater.prototype.init.call(this)};
SKUNAMICPU.TessendorfIWaveWater.prototype.reset=function(){var a;for(a=0;a<this.numVertices;a++)this.prevHeight[a]=0,this.vertDeriv[a]=0;SKUNAMICPU.HeightFieldWater.prototype.reset.call(this)};
