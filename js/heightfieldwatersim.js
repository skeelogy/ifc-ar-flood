...
PipeModelWater.prototype.sim = function (dt) {
    ...
    for (i = 1; i < resMinusOne; i++) {
        for (j = 1; j < resMinusOne; j++) {
            ...
            // this.sourceField[idx] = (this.sourceField[idx] - this.__meanHeight) * this.obstacleField[idx] + this.__meanHeight;
            //FIXME: the obstacleField is generated by comparing against mean height
            this.sourceField[idx] *= this.obstacleField[idx];  //TODO: take into account mean height
